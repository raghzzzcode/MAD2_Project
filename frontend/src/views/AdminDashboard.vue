          ...
          <div class="lot-card shadow">
            ...
            <div class="slot-grid">
              <div
                ...
                :key="index"
                :class="['slot', slot === 'A' ? 'available' : 'occupied']"
                @click="goToViewDeletePs(lot.id, index + 1)"
              >
                {{ slot }}
              </div>
            </div>
...
export default {
  ...
  data() {
    return {
      parkingLots: [
        { id: 1, occupied: 3, total: 15, slots: ['A', 'O', 'A', 'A', 'O', 'O', 'A', 'A', 'A', 'A', 'A', 'A', 'A', 'A', 'A'] },
        { id: 2, occupied: 4, total: 10, slots: ['O', 'A', 'A', 'A', 'A', 'A', 'A', 'O', 'A', 'O'] },
        { id: 3, occupied: 4, total: 10, slots: ['O', 'A', 'A', 'A', 'A', 'A', 'A', 'O', 'A', 'O'] }
      ]
    };
  },
  methods: {
