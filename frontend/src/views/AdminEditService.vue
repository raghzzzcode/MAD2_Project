      ...
      <form @submit.prevent="submitForm" class="parking-form">
        ...
        <div class="mb-3">
          ...
          <input
            ...
            class="form-control"
            id="price_per_hour"
            v-model="parking.price_per_hour"
            required
            min="0"
          />
        </div>
...
export default {
  ...
  methods: {
    submitForm() {
      console.log("Submitted data:", this.parking);
      alert("Dummy: Parking lot updated successfully!");
